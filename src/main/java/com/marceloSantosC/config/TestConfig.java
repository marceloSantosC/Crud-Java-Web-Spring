package com.marceloSantosC.config;
...
import com.marceloSantosC.repositories.OrderItemRepository;
import com.marceloSantosC.repositories.OrderRepository;
import com.marceloSantosC.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem oi1 = new OrderItem(null, o1, p1, 2, p1.getPrice());
